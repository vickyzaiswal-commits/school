...
//       {/* Overview Content */}
//       {activeTab === 'overview' && data.showIntroduction && data.introduction.show && (
//         <div>
//           {/* Introduction */}
...
//                       <span className="text-gray-600 text-right">{item.activity}</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-4">Career Guidance Services</h3>
//                 <div className="space-y-4">
//                   {filteredCareerServices.map((service, index) => {
//                     const IconComponent = service.icon;
//                     return (
...
//               <div>
//                 <h3 className="text-xl font-semibold text-gray-800 mb-4">University Placement Record</h3>
...
//                             <span className="text-sm font-medium">{record.university}</span>
//                           </div>
//                           <span className="text-green-700 font-semibold text-sm">{record.count}</span>
//                         </div>
//                       );
//                     })}
//                   </div>
...
//             {/* Placement Partners */}
//             <div className="bg-gray-50 rounded-lg p-6">
//               <h3 className="text-xl font-semibold text-gray-800 mb-4">Our University Partners</h3>
//               <p className="text-gray-600 mb-6">
//                 We have strong connections with leading universities and institutions worldwide
//               </p>
